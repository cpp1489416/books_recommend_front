<template>
  <div class="app-container" id="app_container" style="position:relative">
    <div ref="filter_container" class="filter-container">
      ...
      <el-button class="filter-item" type="primary" icon="el-icon-refresh" @click="getFMeasure">Refresh</el-button>
  ...
  export default {
    ...
    methods: {
      async getFMeasure() {
        ...
        var that = this
        await this.ajax.get('/recommendations/f_measure').then(response => {
      ...
      async regenerate() {
        ...
        this.ajax.put('/recommendations/f_measure', {
          ks: ks
        }).then(response => {
