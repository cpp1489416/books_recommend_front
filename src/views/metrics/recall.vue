<template>
  <div class="app-container" id="app_container" style="position:relative">
    <div ref="filter_container" class="filter-container">
      ...
      <el-button class="filter-item" type="primary" icon="el-icon-refresh" @click="getRecall">Refresh</el-button>
  ...
  export default {
    ...
    methods: {
      async getRecall() {
        ...
        var that = this
        await this.ajax.get('/recommendations/recall').then(response => {
      ...
      async regenerate() {
        ...
        this.ajax.put('/recommendations/recall', {
          ks: ks
        }).then(response => {
